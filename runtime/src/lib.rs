...
impl pallet_nicks::Config for Runtime {
	// The Balances pallet implements the ReservableCurrency
	...
	// Configure the FRAME System Root origin as the Nick pal 
	// https://paritytech.github.io/substrate/master/frame_sy.

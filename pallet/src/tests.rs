...
fn commit_outcome_full()
{
    new_test_ext().execute_with(|| {
        ...
        let tally_commitment: HashBytes = [ 37, 118, 14, 222, 107, 231, 161, 8, 52, 169, 234, 245, 166, 62, 69, 172, 26, 199, 178, 141, 165, 53, 210, 4, 236, 207, 179, 101, 71, 204, 237, 99 ];        let proof_batches: vec::Vec<(ProofData, CommitmentData)> = vec::Vec::from([(process_proof_data, process_commitment), (tally_proof_data, tally_commitment)]);
